...
init_materials :: proc() -> bool {
	G_MATERIAL_REF_ARRAY = common.ref_array_create(MaterialResource, MAX_MATERIALS, G_RENDERER_ALLOCATORS.main_allocator)
	G_MATERIAL_RESOURCE_ARRAY = make([]MaterialResource, MAX_MATERIALS, G_RENDERER_ALLOCATORS.resource_allocator)
...
allocate_material_ref :: proc(p_name: common.Name) -> MaterialRef {
	ref := MaterialRef(common.ref_create(MaterialResource, &G_MATERIAL_REF_ARRAY, p_name))
