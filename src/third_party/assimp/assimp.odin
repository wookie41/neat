...
foreign assimp {
	...
	import_file :: proc(pFile1: cstring, flags: PostProcessFlags) -> ^aiScene ---
	...
	apply_post_processing :: proc(pScene: ^aiScene, pFlags: PostProcessFlags) -> ^aiScene ---
	...
	get_material_property :: proc(
		pMat: ^aiMaterial,
		pKey: cstring,
		type: u32,
		index: u32,
		pPropOut: ^^aiMaterialProperty,
	) -> aiReturn ---
	@(link_name = "aiGetMaterialFloatArray")
	get_material_floatArray :: proc(
		pMat: ^aiMaterial,
		pKey: cstring,
		type: u32,
		index: u32,
	...
	get_material_integerArray :: proc(
		pMat: ^aiMaterial,
		pKey: cstring,
		type: u32,
		index: u32,
...
PostProcessFlags :: distinct bit_set[aiPostProcessSteps;u32]
